    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="relative z-20 max-w-4xl mx-auto px-5 sm:px-8 pt-28 pb-20">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">Get in Touch</h1>
          <p className="text-sm text-white/60 mt-2">Have a question, suggestion, or just want to say hello? I&rsquo;d love to hear from you.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div>
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl h-64 flex items-center justify-center shadow-xl mb-6">
              <div className="text-center">
                ...
                <p className="text-xs text-white/40">Map Placeholder</p>
              </div>
            </div>

            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-xl">
              <h3 className="text-base font-bold text-white mb-4 drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Contact Information</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/50">hello@iggysblog.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-xl bg-accent/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/50">+1 (555) 123-4567</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 sm:p-8 shadow-xl">
            <h3 className="text-base font-bold text-white mb-6 drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Send a Message</h3>
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-white/50 mb-1.5">Your Name</label>
                <input type="text" placeholder="John Doe" className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 text-sm focus:outline-none focus:border-accent transition-colors" />
              </div>
              <div>
                <label className="block text-xs font-medium text-white/50 mb-1.5">Your Email</label>
                <input type="email" placeholder="john@example.com" className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 text-sm focus:outline-none focus:border-accent transition-colors" />
              </div>
              <div>
                <label className="block text-xs font-medium text-white/50 mb-1.5">Message</label>
                <textarea rows={5} placeholder="Write your message here..." className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 text-sm focus:outline-none focus:border-accent transition-colors resize-none" />
              </div>
