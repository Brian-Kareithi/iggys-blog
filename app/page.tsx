      ...
      <div className="w-full max-w-6xl px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-28">
          ...
          <div className="group border border-zinc-200 px-8 py-10 text-center hover:border-accent transition-colors cursor-pointer">
            ...
            <h3 className="mt-5 text-sm font-bold tracking-[0.15em] text-black">
              TRAVEL
            </h3>
            <p className="mt-2 text-sm italic text-accent">
              Wanderlust &amp; Words
            </p>
            <div className="mt-4 text-xs font-medium tracking-wide text-foreground group-hover:text-accent transition-colors">
              READ MORE &rarr;
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <h4 className="mt-4 text-xs font-bold tracking-wider text-black">
              FRESH STORIES
            </h4>
        ...
        <div className="flex justify-end items-center gap-3">
          ...
          <a
            href="#"
            className="text-[11px] font-medium text-accent hover:underline tracking-wide"
          >
            VIEW ALL
          </a>
        </div>
